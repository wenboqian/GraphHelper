...
// 菜单数据
const menuItems = [
	getItem('try demo', '/flow1', <BarsOutlined />),
	getItem('hlo graph visualization', '/renderByList', <BarsOutlined />),
	// getItem('drag demo', '/flow2', <BarsOutlined />),
	// getItem('other demo', '/flow3', <BarsOutlined />),
];
